---
layout: "vcloud"
page_title: "Viettel IDC Cloud: viettelidc_volume_attachment"
...
# viettelidc\_volume\_attachment
...
```
terraform import viettelidc_volume_attachment.attach <instance_id>/<volume_id>
```
