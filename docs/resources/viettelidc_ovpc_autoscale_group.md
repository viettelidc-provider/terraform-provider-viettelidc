---
layout: "vcloud"
page_title: "Viettel IDC Cloud: viettelidc_ovpc_autoscale_group"
sidebar_current: "docs-viettelidc-resource-autoscale-group"
description: |-
  Provides a ViettelIDC Autoscale Group.
---

# viettelidc\_ovpc\_autoscale\_group
...
```
terraform import viettelidc_ovpc_autoscale_group.web <autoscale_group_id>
```
