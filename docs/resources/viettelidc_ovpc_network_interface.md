...
```hcl
resource "viettelidc_ovpc_network_interface" "nic_static" {
  name           = "my-nic-static"
  subnet_id      = viettelidc_ovpc_subnet.private.id
...
```
terraform import viettelidc_ovpc_network_interface.nic <network_interface_id>
```
