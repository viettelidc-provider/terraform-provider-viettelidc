---
layout: "vcloud"
page_title: "Viettel IDC Cloud: viettelidc_certificate"
...
```hcl
resource "viettelidc_certificate" "tls" {
  name        = "my-tls-cert"
...
```
terraform import viettelidc_certificate.tls <certificate_id>
```
