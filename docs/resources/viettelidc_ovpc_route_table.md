---
layout: "vcloud"
page_title: "Viettel IDC Cloud: viettelidc_ovpc_route_table"
sidebar_current: "docs-viettelidc-resource-route-table"
description: |-
  Provides a ViettelIDC Route Table.
---

# viettelidc\_ovpc\_route\_table

Provides a Route Table on ViettelIDC. Use `viettelidc_ovpc_route_table_association` to associate subnets with the route table.
...
```
terraform import viettelidc_ovpc_route_table.main <route_table_id>
```
