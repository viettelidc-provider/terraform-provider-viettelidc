...
require (
	...
	github.com/viettelidc-provider/viettelidc-api-client-go/service/vpc v1.0.0
)

replace github.com/viettelidc-provider/viettelidc-api-client-go/service/vpc => ../codegen/gen/vpc
